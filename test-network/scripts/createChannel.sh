...
createChannelGenesisBlock() {
  setGlobals Merkaba
	infoln CORE_PEER_LOCALMSPID=$CORE_PEER_LOCALMSPID
	infoln CORE_PEER_TLS_ROOTCERT_FILE=$CORE_PEER_TLS_ROOTCERT_FILE
	infoln CORE_PEER_MSPCONFIGPATH=$CORE_PEER_MSPCONFIGPATH
	infoln CORE_PEER_ADDRESS=$CORE_PEER_ADDRESS
	which configtxgen
	if [ "$?" -ne 0 ]; then
...
infoln "Joining merkaba peer to the channel..."
joinChannel Merkaba
infoln "Joining visa peer to the channel..."
joinChannel Visa
infoln "Joining socio1 peer to the channel..."
joinChannel Socio1

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for merkaba..."
setAnchorPeer Merkaba
infoln "Setting anchor peer for visa..."
setAnchorPeer Visa
infoln "Setting anchor peer for socio1..."
setAnchorPeer Socio1
